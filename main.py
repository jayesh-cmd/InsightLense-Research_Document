    ...
    try:
        response = client.models.generate_content(
            ...
            contents=[
                ...
                "Analyze this image. If it is a chart or graph, extract the specific numbers, trends, axis labels, and legend meanings. If it is a table, summarize the key rows."
            ]
        )
...
def get_ai_response(query: str):
    ...
    # INSTRUCTIONS:
    0. **context:** Only reply from the context you have given, if user ask something that is not related or in the context just reply with an apology that this does not conisit in the document.
    1. **Visuals:** Use [VISUAL ANALYSIS] sections to answer questions about charts.
    2. **Targets:** Look for EXACT numbers (e.g., "2%", "20%") for NDS3 targets.
    3. **Tables:** Do not confuse 2024 vs 2025 columns.
